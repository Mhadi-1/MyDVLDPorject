    ...
    public class clsDetainedLicense
    {
        ...
        private bool _AddNewDetainedLicense()
        {
            ...
            this.DetainID = ClsDetainedLicenseDataAccess.AddNewDetainedLicense(
                this.LicenseID, this.DetainDate.Value, this.FineFees, this.CreatedByUserID);
        ...
        private bool _UpdateDetainedLicense()
        {
            ...
            return ClsDetainedLicenseDataAccess.UpdateDetainedLicense(
                this.DetainID, this.LicenseID, this.DetainDate.Value, this.FineFees, this.CreatedByUserID);
        }
